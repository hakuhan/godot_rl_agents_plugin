...
var inferencer_script = ONNXExtension

var inferencer : ONNXExtension = null
...
func run_inference(obs: Array, state_ins: int) -> Dictionary:
	if inferencer == null:
		...
		return {}
	return inferencer.run_inference(obs, state_ins)


func _notification(what):
	if what == NOTIFICATION_PREDELETE:
		inferencer.free_disposables()
		inferencer.free()
